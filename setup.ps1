...
if (Test-Path "apps/backend") {
    try {
        ...
        Write-Info "Set LLM_API_KEY in apps/backend/.env before running AI analysis flows."
...
Note: Configure LLM_API_KEY in apps/backend/.env before running AI analysis flows.
"@
}
