...
## 📦 Installation Steps
 ...
 Note: Before You Run AI Analysis
 
 Create `apps/backend/.env` from `apps/backend/.env.sample` and set `LLM_API_KEY` to your Zhipu API key before uploading resumes or running matching flows.
